...
const Content = () => {
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <button class="flex justify-center items-center mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">Let's Go<ArrowRight size={20}/></button>
    </div>
    </section>
  )
}
