  ...
  return (
    ...
    <header className="sticky text-slate-900 bg-transparent body-font rounded-full cursor-pointer">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <div className="flex lg:w-2/5 flex-wrap items-center text-lg md:ml-auto">
        ...
        <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
          <button className="inline-flex text-white items-center bg-yellow-500 text-slate-50 border-0 py-2 px-6 focus:outline-none hover:bg-pink-700 text-base mt-4 rounded-full md:mt-0">Explore
            <ArrowRight size={20}/>
          </button>
        </div>
      </div>
